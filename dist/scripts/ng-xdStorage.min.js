...
function(){e.$apply(function(){g=!0;b.resolve()})};xdStorage.init(a);return b.promise},version:function(){return xdStorage.version()},local:{setItem:function(a,c){return b("local","setItem",a,c)},getItem:function(a){return b("local","getItem",a)},removeItem:function(a){return b("local","removeItem",a)},key:function(a){return b("local","key",a)},clear:function(){return b("local","clear")}},session:{setItem:function(a,c){return b("session","setItem",a,c)},getItem:function(a){return b("session","getItem",
a)},removeItem:function(a){return b("session","removeItem",a)},key:function(a){return b("session","key",a)},clear:function(){return b("session","clear")},sync:function(){return b("session","sync")}}}}]);
